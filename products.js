const ranks = [
  {
    ...
    perks: ["Ace rank and exclusive Ace tag", "Ace Kit every 18 hours", "2 Shiny Keys", "6 Rare Candy", "6 Ultra Balls + 12 Quick Balls", "50 XP", "RTP cooldown: −30 seconds", "Pokédex RTP bonus: −10s at 50% · −20s complete", "Rank-based kit cooldown reduction access", "30 seconds faster RTP cooldown"]
  },
  {
    ...
    perks: ["Champion rank and exclusive Champion tag", "Champion Kit every 18 hours", "1 Legendary Key + 1 Shiny Key", "8 Rare Candy", "8 Ultra Balls + 16 Quick Balls", "64 XP", "RTP cooldown: −60 seconds", "Pokédex RTP bonus: −10s at 50% · −20s complete", "Rank-based kit cooldown reduction access", "60 seconds faster RTP cooldown"]
  },
  {
    ...
    perks: ["Master rank and exclusive Master tag", "Master Kit every 18 hours", "2 Beast Balls", "1 Legendary + 1 Shiny + 1 Vote Key", "16 Rare Candy", "32 Quick Balls", "96 XP", "RTP cooldown: −90 seconds", "Pokédex RTP bonus: −10s at 50% · −20s complete", "Rank-based kit cooldown reduction access", "90 seconds faster RTP cooldown"]
  },
  {
    ...
    perks: ["Legend rank and exclusive Legend tag", "Legend Kit every 18 hours", "1 Master Ball", "1 Shiny Key + 3 Vote Keys", "46 Rare Candy", "46 Quick Balls", "178 XP", "RTP cooldown: −120 seconds", "Pokédex RTP bonus: −10s at 50% · −20s complete", "Up to 6 hours of kit cooldown reduction", "120 seconds faster RTP cooldown"]
  }
];
